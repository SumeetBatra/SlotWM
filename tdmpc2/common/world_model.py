...
class WorldModel(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self._dynamics = layers.mlp(cfg.true_latent_dim + cfg.action_dim + cfg.task_dim, 2 * [cfg.mlp_dim],
                                    cfg.true_latent_dim, act=layers.SimNorm(cfg))
        self._reward = layers.mlp(cfg.true_latent_dim + cfg.action_dim + cfg.task_dim, 2 * [cfg.mlp_dim],
                                  max(cfg.num_bins, 1))
    ...
    def encode(self, obs, task):
        ...
        elif self.cfg.obs == 'rgb' and self.cfg.include_state and isinstance(obs,
                                                                             TensorDict):  # Iterate through buffer batch for update
